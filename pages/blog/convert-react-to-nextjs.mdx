...
<Head>
  ...
  <meta name="description" content="This articles describes my experience switching from a React frontend app to using Next.js, some problems encountered, and reasons for making the switch."/>
</Head>
<NavBarBlog />
...
<div className="container">
  <Image
    alt='react-to-nextjs'
    src='/img/blog1-fe-libraries.png'
    priority
    width={0}
    height={0}
    sizes="100vw"
...
Now when you run <span className="has-text-weight-bold">npm run build</span> a new `/out` folder will be generated at the root of your project directory that contains your production build's static assets.
...
<div className="title is-4 has-text-info"> 
  {STRINGS.blogs[0].date} - <span className="title is-5 has-text-info">by {STRINGS.blogAuthors[0].author}</span>
</div>
