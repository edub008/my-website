...
For React or Next.js developers, this means you'll need to add the `.well-known/ic-domains` and `.ic-assets.json` files to the `/public` folder at your project root and rely on your framework's build process to properly include them.
