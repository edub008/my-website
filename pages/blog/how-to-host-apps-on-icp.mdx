...
<Head>
  ...
  <meta name="description" content="This article discusses why hosting your web apps on the Internet Computer (ICP) might make sense and lists the steps to take to successfuly launch your apps on ICP both locally and in production."/>
</Head>
<NavBarBlog />
...
<h1 className="title is-3 has-text-primary"> {STRINGS.blogs[1].title} </h1>

<div className="title is-4 has-text-info"> 
  {STRINGS.blogs[1].date} - <span className="title is-5 has-text-info">14 min read</span>
</div>

<div className="container">
  <Image
    alt='react-to-nextjs'
    src='/img/blog2-internet-computer.png'
    priority
    width={0}
    height={0}
    sizes="100vw"
...
<div className="container">
  <Image
    ...
    src='/img/icp-cost-efficiency.jpeg'
    priority
    width={0}
    height={0}
    sizes="100vw"
...
<h3>Configure Your App for IC Hosting</h3>

With the template project successfuly running, hopefully you have a better understanding of how to run and deploy apps on the Internet Computer. But what if you want to test your own app(s) on the IC instead of the Hello World template? Well the good news is that's there's two basic steps:
...
Once your app is successfuly running in the local environment and you're ready to deploy to production you'll need to aquire and add ICP cycles to your canister(s).
