  ...
  return (
    <div style={{transform: 'scale3d(.4,.4,.4)'}}>
      <div className="cubes">
        ...
        <div className="rubik-cube" data-cube="121">
          <div className="cube-wrap">
            <div className="cube-top">
            </div>
            <div className="cube-bottom"></div>
        ...
        <div className="rubik-cube" data-cube="131">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="211">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="221">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="231">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="311">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="321">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="331">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="112">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="122">
          <div className="cube-wrap">
            <div className="cube-top">
            </div>
            <div className="cube-bottom"></div>
        ...
        <div className="rubik-cube" data-cube="132">
          <div className="cube-wrap">
            <div className="cube-top">
            </div>
            <div className="cube-bottom"></div>
        ...
        <div className="rubik-cube" data-cube="212">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="222">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="232">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="312">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="322">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="332">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="113">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="123">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="133">
          <div className="cube-wrap">
            <div className="cube-top">
            </div>
            <div className="cube-bottom"></div>
        ...
        <div className="rubik-cube" data-cube="213">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="223">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="233">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="313">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="323">
          <div className="cube-wrap">
            <div className="cube-top">
        ...
        <div className="rubik-cube" data-cube="333">
          <div className="cube-wrap">
            <div className="cube-top">
