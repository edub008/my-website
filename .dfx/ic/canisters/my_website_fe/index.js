...
export const canisterId = process.env.MY_WEBSITE_FE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./my_website_fe.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the my_website_fe canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./my_website_fe.did.js")._SERVICE>}
 */
export const my_website_fe = createActor(canisterId);
